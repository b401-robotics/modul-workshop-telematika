...
\begin{enumerate}
    ...
    \item Komponen Modul LED Chaser		    (1x)
    \begin{enumerate}
        \item PCB Modul         (1x)
        \item PCB Modul         (1x)
        \item Resistor 1K Ohm   (10x)
        \item Resistor 2K Ohm   (1x)
        \item Resistor 10K Ohm  (1x)
        \item Capacitor 1uF     (2x)
        \item Resistor Variable (1x)
        \item Header Male 2 Pin (1x)
        \item NE555 IC          (1x)
        \item CD4017 IC         (1x)
    \end{enumerate}    
\end{enumerate}
...
\begin{enumerate}
    \item Siapkan semua peralatan yang disebutkan dan panaskan solder
    \item Pelajari panduan "Cara Menyolder SMD"
    \item Siapkan PCB yang akan disolder
    \item Siapkan komponen SMD yang akan disolder
    \item Hubungkan rangkaian dan komponen menggunakan timah yang dipanaskan dengan solder
    sesuai skematik berikut (PERINGATAN: berhati-hatilah saat meng-handle komponen SMD
    karena ukurannya yang sangat kecil sehingga mudah hilang)
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{P2/img/smd.png}
        \caption{Skematik SMD}
        \label{fig:SkematikSMD}
    \end{figure}
    \item Amati output yang dihasilkan, dokumentasikan hasil output dalam bentuk lampiran
\end{enumerate}
