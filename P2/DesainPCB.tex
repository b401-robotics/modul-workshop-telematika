...
\begin{enumerate}
    ...
    \begin{center}
        ...
        \begin{tabular}{|c|p{2cm}|m{2cm}|m{2cm}|m{2cm}|}
            ...
            \hline
            \includegraphics[width=0.05\linewidth]{P2/img/Header_1x7_2.png} &  {\fontsize{8}{6}\selectfont HEADER 1x7} &  {\fontsize{8}{6}\selectfont WorTel Library} & 1 & - \\
            \hline
            \includegraphics[width=0.05\linewidth]{P2/img/Header_1x5_2.png} & {\fontsize{8}{6}\selectfont HEADER 1X5} & {\fontsize{8}{6}\selectfont WorTel Library} & 1 &  - \\
            \hline
            ...
            \hline
            \includegraphics[width=0.05\linewidth]{P2/img/CH340_2.png} & {\fontsize{8}{6}\selectfont CH340} &  {\fontsize{8}{6}\selectfont WorTel Library} & 1 & - \\
            \hline
            ...
            \hline
            \includegraphics[width=0.1\linewidth]{P2/img/Capacitor_2.png} & {\fontsize{8}{6}\selectfont Capacitor} &  {\fontsize{8}{6}\selectfont WorTel Library} & 5 & {\fontsize{8}{6}\selectfont 100uF(3), 100nf(1), 1uF(1)} \\
            \hline
            ...
            \hline
            \includegraphics[width=0.1\linewidth]{P2/img/NMOSFET_2.png} & {\fontsize{8}{6}\selectfont NMOSFET} &  {\fontsize{8}{6}\selectfont WorTel Library} & 2 & - \\
            \hline
...
\end{table}
    ...
    \item Hasil dari rangkaian dari Minimum System ESP8266 adalah sebagai berikut :
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.6\linewidth]{P2/img/gambar23.jpg}
