...
\begin{enumerate}
    ...
    \begin{center}
        ...
        \begin{tabular}{|c|p{2cm}|m{2cm}|m{2cm}|m{2cm}|}
            ...
            \hline
            \includegraphics[width=0.1\linewidth]{P1/img/komponen_ttl_connector.jpg} & {\fontsize{8}{6}\selectfont TTL Connector} &  {\fontsize{9}{6}\selectfont WorTel2023 Library} & 1 & - \\
            \hline
            \includegraphics[width=0.1\linewidth]{P1/img/komponen_3.3_voltage_regulator.jpg} & {\fontsize{10}{6}\selectfont 3,3 Voltage Regulator} &  {\fontsize{9}{6}\selectfont WorTel2023 Library} & 1 & - \\
            \hline
            \end{tabular}
...
\begin{enumerate}
    ...
    sesuai dengan tatanan footprint.
        \begin{figure}[H]
            ...
            \includegraphics[width=0.45\linewidth]{P1/img/gambar28.jpeg}
